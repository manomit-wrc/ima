        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a href="#settings" data-toggle="tab">News - Add</a></li>
            </ul>
            <div class="tab-content">
              
              <div class="tab-pane active" id="settings">
                <form name="frmTeam" method="post" action="/admin/news/store" class="form-horizontal" enctype="multipart/form-data">
                  {{csrf_field()}}
                  ...
                  <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                      <textarea id="textarea_id" name="description" class="form-control">{{ old('description')}}</textarea>
                  ...
                  <div class="form-group {{ $errors->has('tag_id') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                      ...
                      @foreach($tags as $key=>$desg)
                        <option value="{{$key}}" {{old('tag_id') == $key ? 'selected' : '' }}>{{$desg}}</option>
                      @endforeach
                      </select>
