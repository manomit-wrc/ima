        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a href="#settings" data-toggle="tab">CMS - Add</a></li>
            </ul>
            <div class="tab-content">
              
              <div class="tab-pane active" id="settings">
                <form name="frmTeam" method="post" action="/admin/cms/store" class="form-horizontal" enctype="multipart/form-data">
                  {{csrf_field()}}
                  ...
                  <div class="form-group {{ $errors->has('full_description') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                      <textarea id="textarea_id" name="full_description" class="form-control">{{ old('full_description')}}</textarea>
