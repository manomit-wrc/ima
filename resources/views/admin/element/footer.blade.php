...
@if(Request::segment(2) === 'event' || Request::segment(2) === 'news' && (Request::segment(3) == 'add' || Request::segment(3) == 'edit'))
...
@if(Request::segment(2) === 'event' && Request::segment(3) === 'gallery')
  {!! Html::style('storage/admin/js//packages/dropzone/dropzone.css') !!}
  {!!Html::script("storage/admin/js/packages/dropzone/dropzone.js")!!}
  {!!Html::script("storage/admin/js/packages/dropzone/dropzone-config.js")!!}
@endif

@if((Request::segment(2) === 'news' && (Request::segment(3) === 'add' || Request::segment(3) === 'edit'))||(Request::segment(2) === 'cms' && (Request::segment(3) === 'add' || Request::segment(3) === 'edit')) ||(Request::segment(2) === 'cmspagedetail' && (Request::segment(3) === 'create' || Request::segment(3) === 'edit')))
...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; <script>document.write(new Date().getFullYear())</script> <a href="#">WRC Technologies</a>.</strong> All rights
    reserved.
</footer>
