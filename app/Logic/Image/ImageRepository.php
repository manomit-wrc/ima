...
{
    public function upload( $form_data,$event_id )
    {

        $validator = Validator::make($form_data, EventGallery::$rules, EventGallery::$messages);
        ...
        $sessionImage = new EventGallery;
        $sessionImage->event_id = $event_id;
    ...
    public function original( $photo, $filename )
    {
        ...
        $image = $manager->make( $photo )->save(public_path().'/uploads/event/gallery/original/' . $filename );
    ...
    public function icon( $photo, $filename )
    {
        ...
        $image = $manager->make( $photo )->resize(200, null, function ($constraint) {
            ...
            ->save( public_path().'/uploads/event/gallery/resize/'  . $filename );
     ...
     */
    public function delete( $originalFilename, $event_id)
    {
